    ...
    <div className="w-full flex flex-col gap-8 md:gap-12">
      ...
      <div className="w-full flex flex-col">
        <SectionHeader
          ...
          description="Taller transaction bars indicate parallel execution."
        />

        {/* Main container - only vertical (left/right) borders */}
        <div className="w-full flex flex-col border-x border-zinc-800 bg-[#0E100F]">
          {/* Legend bar */}
          ...
          <div className="px-6 sm:px-10 border-l border-t border-b border-zinc-800 bg-[linear-gradient(153deg,#18181B_0%,rgba(24,24,27,0)_100%)]">
